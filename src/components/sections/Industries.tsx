...
export const Industries = () => {
  return (
    <section id="industries" className="relative py-24 overflow-hidden">
      ...
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-sa-gold/5 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-sa-purple/5 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-sa-purple/30 bg-sa-purple/10 mb-4">
            <span className="text-xs font-semibold text-sa-purple uppercase tracking-wider">Industries Served</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            Powering Nepal's{" "}
            <span className="text-gradient-purple">Growth Sectors</span>
          </h2>
          <p className="text-muted-foreground text-lg">
            From mega infrastructure projects to sustainable urban development, 
            SA supports diverse sectors with precision testing services.
          </p>
        </div>
          ...
          {industries.map((industry) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                {/* Icon badge */}
                <div className="absolute bottom-4 left-6 w-12 h-12 rounded-xl bg-sa-gold/20 backdrop-blur-sm border border-sa-gold/30 flex items-center justify-center">
                  <industry.icon className="w-6 h-6 text-sa-gold" />
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {industry.applications.map((app, idx) => (
                    ...
                    >
                      <span className="w-1 h-1 rounded-full bg-sa-purple" />
                      {app}
                    </div>
                  ))}
                </div>
