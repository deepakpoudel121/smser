...
export const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-sa-gold/5 to-transparent z-10" />
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-sa-gold/30 bg-sa-gold/10 backdrop-blur-sm animate-fade-in">
              <span className="w-2 h-2 rounded-full bg-sa-purple animate-pulse" />
              <span className="text-sm font-medium text-sa-gold">Nepal's Premier Materials Testing Laboratory</span>
            </div>
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight tracking-tight">
                ...
                <span className="text-sa-purple">.</span>
              </h1>
          ...
          <div className="relative hidden lg:block">
            <div className="relative aspect-square">
              ...
              <div className="absolute inset-8 rounded-2xl overflow-hidden border border-border/50 shadow-2xl shadow-sa-gold/10">
                <img 
              ...
              <div className="absolute top-4 right-4 glass-card rounded-xl p-4 animate-float">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-sa-gold/20 flex items-center justify-center">
                    <svg className="w-5 h-5 text-sa-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="absolute bottom-4 left-4 glass-card rounded-xl p-4 animate-float" style={{ animationDelay: '2s' }}>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-sa-purple/20 flex items-center justify-center">
                    <svg className="w-5 h-5 text-sa-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -left-4 w-24 h-24 border border-sa-gold/30 rounded-2xl" />
              <div className="absolute -bottom-4 -right-4 w-32 h-32 border border-sa-purple/20 rounded-2xl" />
            </div>
          </div>
        </div>
      </div>
