...
export const WhyChoose = () => {
  return (
    <section className="relative py-24 bg-gradient-to-b from-muted/50 to-background overflow-hidden">
      ...
      {/* Decorative Elements */}
      <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-sa-gold/20 to-transparent" />
      <div className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-sa-purple/20 to-transparent" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-sa-gold/30 bg-sa-gold/10 mb-4">
            <span className="text-xs font-semibold text-sa-gold uppercase tracking-wider">Why Choose Us</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => (
            ...
            >
              {/* Stat Badge */}
              <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-sa-gold/10 border border-sa-gold/20">
                <span className="text-xs font-bold text-sa-gold">{feature.stat}</span>
              </div>

              {/* Icon */}
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-sa-gold/20 to-sa-purple/20 border border-sa-gold/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <feature.icon className="w-7 h-7 text-sa-gold" />
              </div>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-gradient-to-r from-sa-purple/30 to-sa-gold/20 border border-sa-gold/30 backdrop-blur-xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <p className="text-4xl lg:text-5xl font-bold text-sa-gold mb-1">24/7</p>
              <p className="text-sm text-muted-foreground">Support Available</p>
            </div>
            <div className="text-center">
              <p className="text-4xl lg:text-5xl font-bold text-sa-purple mb-1">100%</p>
