...
export const Blog = () => {
  ...
  // Combine "All" with existing categories
    ...
    <section id="blog" className="relative py-24 bg-gradient-to-b from-background to-muted/30">
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            {featuredPost && (
              <article 
                ...
                className="group relative rounded-2xl border border-border/50 overflow-hidden bg-card/30 backdrop-blur-sm hover:border-primary/30 transition-all duration-500 lg:row-span-2 cursor-pointer"
              >
            ...
            <div className="space-y-6">
              {regularPosts.map((post) => (
                <article 
                  ...
                  className="group flex gap-4 p-4 rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm hover:border-primary/30 transition-all duration-300 cursor-pointer"
                >
        ...
        <div className="mt-12 text-center">
          <Button variant="hero-outline" size="lg" onClick={handleViewAll}>
            View All Articles
