...
export const About = () => {
  return (
    <section id="about" className="relative py-24 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-sa-gold/5 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-sa-purple/5 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 md:right-8 glass-card rounded-xl p-6 max-w-xs">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center p-3 rounded-lg bg-sa-purple/10">
                  <p className="text-3xl font-bold text-sa-purple">24/7</p>
            ...
            {/* Decorative */}
            <div className="absolute -top-4 -left-4 w-20 h-20 border-2 border-sa-gold/30 rounded-xl" />
          </div>

          {/* Right - Content */}
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-sa-purple/30 bg-sa-purple/10">
                <span className="text-xs font-semibold text-sa-purple uppercase tracking-wider">About South Asia</span>
              </div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Southasia Materials Science and Engineering Research (SA), strategically located in Chitwan, Nepal, 
            ...
            {/* Vision */}
            <div className="p-6 rounded-xl border border-sa-gold/30 bg-gradient-to-br from-sa-gold/5 to-transparent">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-lg bg-sa-gold/20 flex items-center justify-center shrink-0">
                  <Eye className="w-6 h-6 text-sa-gold" />
                </div>
                <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {values.map((value) => (
                <div 
                  key={value.title}
                  className="p-4 rounded-xl border border-border/50 bg-card/50 hover:border-sa-gold/30 transition-all duration-300 group"
                >
                  <value.icon className="w-6 h-6 text-sa-gold mb-3 group-hover:scale-110 transition-transform" />
